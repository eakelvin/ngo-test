    ...
    return (
        <footer className="pt-10 bg-gray-800 text-white">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                        ...
                        >
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="pl-12 pr-3 py-2 shadow-sm"
                                    {...register("email")}
                                />
                            </div>
                ...
                <div className="mt-5 py-5 border-t border-gray-700 md:flex items-center justify-between sm:flex">
                    <p className="text-gray-300">© 2024 Essential Aid. All rights reserved.</p>
                    <div className="flex items-center gap-x-6 text-gray-400 sm:mt-0 mt-6">
                        <Link href="">
